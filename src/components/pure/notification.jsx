...
const Notification = () => {
  ...
  return createPortal(
    <AnimatePresence>
      {notification &&
        <motion.div
          className={`fixed bottom-0 right-0 mb-4 mx-4 lg:mb-16 lg:mx-20 bg-white border ${notification.type === 'error' ? 'border-red-700' : notification.type === 'success' ? 'border-green-700' : ''} dark:bg-slate-900 text-black dark:text-white rounded-lg shadow-lg p-4 w-9/12 md:w-6/12 lg:w-4/12 xl:w-3/12 2xl:w-2/12}`}
